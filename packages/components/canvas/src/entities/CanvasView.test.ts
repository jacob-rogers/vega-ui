...
describe('CanvasView', () => {
  ...
  describe('changeActiveData', () => {
    ...
    // TODO: Нужно ввести поправку на layer.x/layer.x и layer.scaleX/layer.scaleY

    test.skip('обновляет linePoints, если задан stage', () => {
  ...
  describe('connectActiveItem', () => {
    ...
    afterEach(() => {
      canvas.disconnect(secondTree, activeData.item);
    });
  });
